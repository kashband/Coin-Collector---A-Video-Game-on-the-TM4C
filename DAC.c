...
// Program written by: Jishnu Basu & Kashif Bandali
// Date Created: 3/6/17 
...
void DAC_Init(void){
	...
	random = 0; //Used to take time to allow clock to set
	GPIO_PORTB_DIR_R |= 0x3F;
	GPIO_PORTB_DEN_R |= 0x3F;
	GPIO_PORTB_DR8R_R |= 0x3F; //Done so TM4C123 can drive more current to DAC circuit
}
